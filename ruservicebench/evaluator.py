"""Оценка одного прогона. Два режима награды:
  STATE — сверка финального состояния песочницы с task.expected (для референс-агента и ЦАМ 2.0);
  JUDGE — оценка по цели/рубрике (для ЦАМ 1.0 без инструментов; и для проактивности).
